...
public class ST25DV02KWPwmCtrlActivity extends STFragmentActivity
    ...
    ST25DV02KWPwmCtrlFragment mFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragment = new ST25DV02KWPwmCtrlFragment();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_save:
                        showToast("Saving new parameters");
                        mFragment.updateTag();
                        break;
                }
                return false;
