...
public class M24LR64KTag extends STVicinityTag implements STType5PasswordInterface, STVicinityConfigInterface {
    ...
    public M24LR64KTag(RFReaderInterface readerInterface, byte[] uid) throws STException {
        super(readerInterface, uid, 64, 32);

        // For M24LR64KTag, we redefine "mSysFile" of parent class Type5Tag in order to use an extended version
        mName = "M24LR64E";
